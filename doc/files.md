...
* soficoin.conf: contains configuration settings for soficoind or soficoin-qt
* soficoind.pid: stores the process id of soficoind while running
...
* debug.log: contains debug information and general logging generated by soficoind or soficoin-qt
